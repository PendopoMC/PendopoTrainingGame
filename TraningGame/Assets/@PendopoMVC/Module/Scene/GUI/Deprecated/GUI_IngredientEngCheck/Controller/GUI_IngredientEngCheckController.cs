...
{
    public class GUI_IngredientEngCheckController : GUI_DataCheckController<GUI_IngredientEngCheckController,GUI_IngredientEngCheckView>
    {
        public override void SetView(GUI_IngredientEngCheckView view)
        {
            base.SetView(view);
            SetCallBack();
        }
