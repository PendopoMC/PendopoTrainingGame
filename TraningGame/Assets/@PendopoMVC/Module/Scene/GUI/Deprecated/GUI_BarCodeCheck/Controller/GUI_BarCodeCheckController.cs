...
{
    public class GUI_BarCodeCheckController : GUI_DataCheckController<GUI_BarCodeCheckController,GUI_BarCodeCheckView>
    {
        public override void SetView(GUI_BarCodeCheckView view)
        {
            base.SetView(view);
            SetCallBack();
        }
