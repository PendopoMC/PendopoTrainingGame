...
{
    public class GUI_LogoCodeCheckController : GUI_DataCheckController<GUI_LogoCodeCheckController,GUI_LogoCodeCheckView>
    {
        public override void SetView(GUI_LogoCodeCheckView view)
        {
            base.SetView(view);
            SetCallBack();
        }
