...
{
    public class GUI_FlavorLogoCheckController : GUI_DataCheckController<GUI_FlavorLogoCheckController,GUI_FlavorLogoCheckView>
    {
        public override void SetView(GUI_FlavorLogoCheckView view)
        {
            base.SetView(view);
            SetCallBack();
        }
